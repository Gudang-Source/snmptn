        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><i class="icon-file-alt"></i> PTN</li>
            </ol>
          </div>
		  <div class="col-lg-12">
			<div class="row">
				<div class="col-lg-6" style="margin-bottom:10px;">
					<button id="tambahPtn" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;Tambah PTN</button>
				</div>
			</div>
			<div class="row">
				<div id="daftarPtn" class="col-lg-8">
					<!--
					untuk daftar ptn
					-->
				</div>
...
<!-- PTN Modal -->
<div class="modal fade" id="ptnModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
$(document).ready(function() {
	$('#daftarPtn').load(base_url+'admin/daftar_ptn');
	
	$('#tambahPtn').click(function() {
		$('#ptnModal').load(base_url+'admin/form_ptn');
