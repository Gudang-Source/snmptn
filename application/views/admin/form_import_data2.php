		  ...
		  <div class="col-lg-5">
			<div class="panel panel-primary">
			  ...
			  <div class="panel-body">
				<form id="formImport" method="post" action="<?php echo base_url(); ?>guru/ac_upload2" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="isemester" name="semester" placeholder="Semester" />
					</div>
					<div class="form-group">
	...
	submitHandler: function(form) {
		...
		$(form).ajaxSubmit({
			beforeSend: function()
			{
				...
				$('#progress').html('Sedang Import Data Siswa...<img src="<?php echo base_url(); ?>asset/images/loading-icon.gif" style="width:20px; height:20px;" />');
				$('#progress').show();
			},
